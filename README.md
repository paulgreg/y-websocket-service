...
This is a fork of [yjs/y-websocket-server](https://github.com/yjs/y-websocket-server), migrated to typescript.
...
`cp src/settings.ts.dist src/settings.ts` and update secret 
